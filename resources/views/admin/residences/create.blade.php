                            ...
                            <form action="{{route('admin.residences.create')}}" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="basic-default-name">تعداد سرویس بهداشتی ایرانی</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="basic-default-name">تعداد تخت خواب 2 نفره</label>
                                            <input type="text" class="form-control" id="basic-default-name"
                                                   name="double_bed">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="basic-default-name">تعداد سرویس بهداشتی فرنگی</label>
                                            <input type="text" class="form-control" id="basic-default-name"
                                                   name="wc_en">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="basic-default-name">تعداد تخت خواب 1 نفره</label>
                                            <input type="text" class="form-control" id="basic-default-name"
                                                   name="single_bed">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="basic-default-name" name="discount">
